...
MySQL - 10.1.29-MariaDB : Database - db10116370penggajian
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`db10116370penggajian` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `db10116370penggajian`;
...
(10,'Finance',1700),
(11,'Accounting',1700),
(12,'Academic Personnel',4000),
(13,'Admissions Office',3500),
(14,'Accounting Services',1000),
(15,'Budget & Planning',3000),
(16,'Bioengineering',3300),
(17,'Enterprise Technology Services',1200),
(18,'Collections',3200),
(19,'Development',4300),
(20,'Det Student Housing',4100),
(21,'Computer Science',2800),
(22,'English Dept',3700),
(23,'Events Center',3200),
(24,'Economics',3600),
(25,'College of Engineering',2800),
(26,'Faculty Club',4800);
...
(20,'Data Scientist',4400.00,4800.00),
(21,'DevOps Engineer',4200.00,4700.00),
(22,'Tax Manager',4000.00,4700.00),
(23,'Database Administrator',3500.00,4500.00),
(24,'UX Designer',4000.00,4400.00),
(25,'HR Manager',3800.00,4600.00),
(26,'Nurse Practitioner',3500.00,4300.00);
...
(1000,'Jl. Jend. Sudirmn Kav 29-31','','Jakarta','DKI Jakarta','IA'),
(1200,'Ruta 157','1233','Bella Vista','Tucuman','AR'),
(1300,'Jl. Pasirluyu','40285','Bandung','West Java','IA'),
...
(2600,'Av Madres de Plaza 25 de Mayo','','Rosario','','AR'),
(2700,'Schwanthalerstr. 7031','80925','Munich','Bavaria','DE'),
(2800,'Jl. Ciganitri Lengkong','40287','Bandung','West Java','IA'),
(3000,'Jl. Halmehara Blok DD-11','','Bekasi','West Java','IA'),
(3100,'Avenida Alvares Cabral','1777','Belo Horizonte','Minas Gerais','BR'),
(3200,'54th Street','5502','Bonnyville','Alberta','CA'),
(3300,'Prologacion Alfonso','2612','Monterrey','Nuevo Leon','MX'),
(3500,'Rua Dona Maria Maxima','142','Santos','Sao Paulo','BR'),
(3600,'1 Gul Crescent','','Singapore','Singapore','SG'),
(3700,'Norfolk Road','','Harare','','ZW'),
(3900,'Al-Ghunaim Tower','','Kuwait City','','KW'),
(4000,'Profesor Rodolfo Gozalez','','Guadapule','Nuevo Leon','MX'),
(4100,'Pierre Laporte','1515','Bromont','Quebec','CA'),
(4300,'2 Tuas Lane','','Singapore','Singapore','SG'),
(4500,'Tarmvej 7','','Aalborg','','DK'),
(4800,'Avenue des pre Seigneurs','465','Ain','Ain','FR'),
(4900,'Skyway House South Block 3','','Hongkong','Hongkong Island','HK');
